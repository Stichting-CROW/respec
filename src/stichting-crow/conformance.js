...
const localizationStrings = {
  ...
  nl: {
    ...
    keywordInterpretation(keywords, plural) {
      return html`<p>
          ${plural ? "De sleutelwoorden" : "Het sleutelwoord"} ${keywords} in
          dit document ${plural ? "zijn" : "is"} hebben een normatieve betekenis
          zoals beschreven in het Engels in 
          <a href="https://tools.ietf.org/html/bcp14">BCP 14</a>
          ${renderInlineCitation("RFC2119")} ${renderInlineCitation("RFC8174")}
          wanneer ${plural ? "ze" : "het"} in hoofdletters geschreven
          ${plural ? "zijn" : "is"}.
        </p>`;
    },
