...
const status2text = {
  "CROW-BASIS": "document",
  "CROW-DEF": "vastgesteld document",
  "CROW-NOTITIE": "notitie",
  "CROW-TVL": "tervisielegging",
  "CROW-WD": "werkdocument",
};
const status2long = {
  ...status2text,
};
...
export function run(conf) {
  ...
  if (conf.isRegular)
    conf.thisVersion = `https://www.w3.org/${publishSpace}/${conf.publishDate.getUTCFullYear()}/${conf.maturity
  ...
  if (conf.previousPublishDate) {
    ...
    if (conf.isTagFinding) {
      ...
      conf.prevVersion = `https://www.w3.org/TR/${conf.previousPublishDate.getUTCFullYear()}/${pmat}-${conf.shortName
  ...
  if (conf.noRecTrack && recTrackStatus.includes(conf.specStatus)) {
    pub(
      "error",
      `Document configured as [\`noRecTrack\`](https://github.com/w3c/respec/wiki/noRecTrack), but its status ("${conf.specStatus
